...
"""
    ...
    def test_normalizes_topic_heading_to_paragraph(self):
        markdown = "正文结语。\n\n## 话题\n#广州餐饮# #老字号闭店# #实体经济#"
        result = convert_with_images(markdown)

        self.assertIn("<p>#广州餐饮# #老字号闭店# #实体经济#</p>", result.html)
        self.assertNotIn("话题：", result.html)
        self.assertNotIn("<h2>话题</h2>", result.html)
        self.assertNotIn("<h1>", result.html)

    def test_normalizes_standalone_hashtag_line_to_prevent_h1(self):
        markdown = "正文结语。\n\n#广州餐饮# #老字号闭店#"
        result = convert_with_images(markdown)

        self.assertIn("<p>#广州餐饮# #老字号闭店#</p>", result.html)
        self.assertNotIn("话题：", result.html)
        self.assertNotIn("<h1>", result.html)
